...
class UnionFindThreeTest {
  ...
  public void test() {
    ...
    /*
     * endOfCurrentList U endOfNextList = 30s+
     *
     * endOfCurrentList U startOfNextList = 30s+
     *  <- the tree is skewed to the left
     *  <- so trying to find the root of the left tree is expensive, not the
     *     right one.
     *
     * startOfCurrentList U endOfNextList = 25s+
     * startOfCurrentList U startOfNextList = 25s+
     *
